...
class AddTopCast extends StatefulWidget {
  const AddTopCast({super.key});

  @override
  State<AddTopCast> createState() => _AddTopCastState();
}

class _AddTopCastState extends State<AddTopCast> {
  ...
  _saveData() async {
    try {
      await uploadImage();
      String id = Uuid().v4();
      AddTopCastModel addTopCastModel = AddTopCastModel(
        id: id,
        name: name.text,
        imageUrls: imageUrls,
      );
      await firebaseFirestore
          .collection('topcast')
          .doc(id)
          .set(addTopCastModel.toMap());
      Fluttertoast.showToast(
        msg: "Top Cast Add Successfully",
